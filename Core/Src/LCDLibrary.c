...
unsigned char a_acentoAgudo[8] = {0x02, 0x04, 0x0E, 0x01, 0x0F, 0x11, 0x0F, 0x00}; // á
unsigned char a_acentoTiu[8] = {0x0D, 0x12, 0x06, 0x01, 0x0F, 0x11, 0x0F, 0x00}; 	// ã
unsigned char e_acentoAgudo[8] = {0x02, 0x04, 0x0E, 0x11, 0x1F, 0x10, 0x0E, 0x00}; // é
unsigned char Cedilha[8] = {0x00, 0x0F, 0x10, 0x10, 0x0F, 0x02, 0x0E, 0x00}; 		// ç
unsigned char o_acentoTiu[8] = {0x0D, 0x12, 0x00, 0x0E, 0x11, 0x11, 0x0E, 0x00}; 	// õ
...
{
	LCD_char_especial(0, a_acentoAgudo);
	LCD_char_especial(1, e_acentoAgudo);
	LCD_char_especial(2, Cedilha);
	LCD_char_especial(3, a_acentoTiu);
	LCD_char_especial(4, o_acentoTiu);
}
